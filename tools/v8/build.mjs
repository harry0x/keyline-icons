 ...
 */
const ICONS = {
  'file-sparkles':        { base: 'file',        stars: [[19.5, 19.5, 3.5], [9, 11, 2]] },
  'folder-sparkles':      { base: 'folder',      stars: [[19.5, 6, 3.5], [8.5, 14.5, 2]] },
  'user-sparkles':        { base: 'user',        stars: [[19.5, 5, 3], [5, 9, 2]] },
  'calendar-sparkles':    { base: 'calendar',    stars: [[19.5, 18.5, 3.5], [8, 14, 2]] },
  'table-sparkles':       { base: 'table',       stars: [[19.5, 5, 3.5], [6.5, 19, 2]], keep: 2 },
  'terminal-sparkles':    { base: 'terminal',    stars: [[18.5, 5.5, 3.5], [12.5, 13, 2]] },
  'globe-sparkles':       { base: 'globe',       stars: [[20, 4, 3], [4, 20, 2]] },
  'camera-sparkles':      { base: 'camera',      stars: [[19.5, 5, 3], [5, 17, 2]] },
  'monitor-sparkles':     { base: 'monitor',     stars: [[19.5, 4.5, 3.5], [7, 9, 2]] },
  'scan-text-sparkles':   { base: 'scan-text',   stars: [[18, 12, 3], [12.5, 17, 2]] },
  'headphones-sparkles':  { base: 'headphones',  stars: [[12, 9, 3], [12, 16, 2]] },
  'lightbulb-sparkles':   { base: 'lightbulb',   stars: [[12, 11.5, 3], [20.5, 20.5, 2]] },
  'cloud-sparkles':       { base: 'cloud',       stars: [[12, 12, 3], [21, 3, 2]] },
  'shield-sparkles':      { base: 'shield',      stars: [[12, 12, 3.5], [20, 4, 2]] },
  'clock-sparkles':       { base: 'clock',       stars: [[20, 4, 3], [5, 19, 2]] },
  'zap-sparkles':         { base: 'zap',         stars: [[20, 4, 3], [4.5, 19.5, 2]] },
  'sticky-note-sparkles': { base: 'sticky-note', stars: [[19.5, 19.5, 3], [9, 9, 2.5]] },
  ...
  'eye-sparkles':         { base: 'eye', baseD: ['M2 12C3.0523 7.3229 7.206 4 12 4C16.794 4 20.9477 7.3229 22 12C20.9477 16.6771 16.794 20 12 20C7.206 20 3.0523 16.6771 2 12Z'],
                            stars: [[12, 12, 3], [20.5, 19.5, 2]] },
  'send-sparkles':        { base: 'send',        stars: [[5, 18.5, 3], [11.5, 21, 2]] },
  'refresh-cw-sparkles':  { base: 'refresh-cw',  stars: [[12, 12, 3], [20.5, 20.5, 2]] },
  'sliders-horizontal-sparkles': { base: 'sliders-horizontal', stars: [[19.5, 5, 3], [4.5, 19, 2]] },
  'layers-sparkles':      { base: 'layers',      stars: [[19.5, 5, 3], [4.5, 19, 2]] },
  'chart-column-sparkles':{ base: 'chart-column',stars: [[19.5, 5, 3], [5.5, 7, 2]] },
  'bell-sparkles':        { base: 'bell',        stars: [[19.5, 5, 3], [4.5, 19, 2]] },
