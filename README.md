...
**1,113 icons, drawn on one 24×24 grid, in four styles and two corner
...
| --- | --- | --- |
| `stroke` | 1,113 | The full set. 2px keylines on a 24 grid. |
| `two-tone` | 1,113 | The stroke drawing over a flat plate at reduced opacity. |
| `duotone` | 1,113 | No outline: a grey body with the detail in full strength. |
| `fill` | 1,113 | Solid, with the detail knocked back out of the shape. |
...
coverage, so 8,904 SVGs in total.
