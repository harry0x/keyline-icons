...
1,113 icons on one 24×24 grid, as React components. Built for shadcn/ui, free
under MIT.
...
```tsx
import { Bell } from "@keyline-icons/react"          // stroke,  1,113 icons
import { Bell } from "@keyline-icons/react/two-tone" // two-tone, 1,113 icons
import { Bell } from "@keyline-icons/react/duotone"  // duotone, 1,113 icons
import { Bell } from "@keyline-icons/react/fill"     // fill,    1,113 icons
